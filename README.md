...
Run the Python script to generate the annotated visualization:
...
## 📁 Project Structure
- `China_vs_USA_usage.py`: The core script that loads the data, formats the graph, and plots the annotated chart.
